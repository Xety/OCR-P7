        ...
        <form action={formAction} className="flex flex-col" noValidate>
            <div className="flex flex-col gap-2">
                ...
                <input
                    ...
                    className="h-16 w-full rounded-[5px] border border-[#d9dee3] bg-white px-4 text-lg text-neutral-950 outline-none transition-shadow focus:border-(--brand) focus:ring-2 focus:ring-[#d3590b33] aria-invalid:border-[#b42318]"
                />
                {state.errors?.email && (
            ...
            <button
                ...
                className="mt-9 h-14.75 w-[calc(100%-38px)] self-center rounded-xl bg-[#202020] px-5 text-lg text-white outline-none transition-colors hover:bg-black focus-visible:ring-2 focus-visible:ring-(--brand) focus-visible:ring-offset-3 active:bg-neutral-800 disabled:cursor-wait disabled:bg-neutral-500"
            >
                {pending
                    ? isLogin
                        ? "Connexion…"
