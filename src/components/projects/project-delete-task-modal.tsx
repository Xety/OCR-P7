...
import { deleteProjectTaskAction } from "@/app/actions/tasks";
import { Modal } from "@/components/ui/modal";
import type { ApiProjectTask } from "@/lib/projects/types";
import type { TaskDeleteState } from "@/lib/tasks/types";

type ProjectDeleteTaskModalProps = {
    open: boolean;
    task: ApiProjectTask;
    onClose: () => void;
};
...
/** Demande confirmation avant de supprimer définitivement une tâche. */
export function ProjectDeleteTaskModal({
    open,
    task,
    onClose,
}: ProjectDeleteTaskModalProps) {
        ...
        >
            <form action={formAction}>
                ...
                <p className="text-sm leading-6 text-[#4B5563]">
                    <span>Voulez-vous vraiment supprimer la tâche</span>
